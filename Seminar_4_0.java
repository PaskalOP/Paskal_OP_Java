//Замерять время за которое добавится 100000 елементов в ArrayList
//Замерять время за которое добавится 100000 елементов в LinkedList

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

public class Seminar_4_0 {
